  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl">
        ...
        {/* Trending Badge */}
        {experience.trending && (
          <div className="absolute top-2 sm:top-3 left-2 sm:left-3 bg-white/90 backdrop-blur-sm text-black px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-medium">
            Trending
          </div>
        )}
        ...
        <button
          ...
          className={cn(
            "absolute top-2 sm:top-3 right-2 sm:right-3 p-1.5 sm:p-2 rounded-full backdrop-blur-sm transition-all z-10",
            isInWishlist 
          ...
          type="button"
        >
          <Heart className={cn("h-3.5 w-3.5 sm:h-4 sm:w-4", isInWishlist && "fill-red-500")} />
        </button>
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-3 sm:p-4 text-white">
          <div className={cn(
            ...
            <h3 className="text-base sm:text-lg md:text-xl font-medium mb-1.5 sm:mb-2 line-clamp-2">{experience.title}</h3>
            ...
            <div className={cn(
              "grid grid-cols-3 gap-1.5 sm:gap-2 mb-3 sm:mb-4 opacity-0 transition-opacity duration-300",
            ...
            <div className={cn(
              ...
              <Button size="sm" variant="outline" className="w-full mt-1.5 sm:mt-2 text-black text-xs sm:text-sm" onClick={handleAddToCart}>
                Add to Cart
              </Button>
            </div>
          </div>
