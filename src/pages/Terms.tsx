...
export default function Terms() {
  return (
    <div className="container mx-auto px-2 sm:px-4 py-6 sm:py-8">
      <h1 className="text-3xl sm:text-5xl font-bold mb-10 mt-16 p-4 bg-white border-b-2 border-gray-200 shadow-sm text-center">Terms and Conditions</h1>
      <div className="max-w-full md:max-w-4xl mx-auto">
        <div>
          <p className="mb-4">These terms and conditions outline the rules and regulations for the use of Slash Experiences's Website, located at Slash Experiences.</p>
          <p className="mb-4">By accessing this website we assume you accept these terms and conditions. Do not continue to use Slash Experiences if you do not agree to take all of the terms and conditions stated on this page.</p>
          ...
          <p className="mb-4">We employ the use of cookies. By accessing Slash Experiences, you agreed to use cookies in agreement with the Slash Experiences's Privacy Policy.</p>
          ...
          <p className="mb-4">Unless otherwise stated, Slash Experiences and/or its licensors own the intellectual property rights for all material on Slash Experiences. All intellectual property rights are reserved. You may access this from Slash Experiences for your own personal use subjected to restrictions set in these terms and conditions.</p>
          ...
          <p className="mb-4">Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Slash Experiences does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Slash Experiences, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Slash Experiences shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
          <p className="mb-4">Slash Experiences reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
          ...
          <p className="mb-4">You hereby grant Slash Experiences a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
          ...
          <ul className="mb-4 list-disc list-inside">
            ...
            <li>the benefit to us from the visibility of the hyperlink compensates the absence of Slash Experiences; and</li>
          ...
          <p className="mb-4">If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Slash Experiences. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
          ...
          <p className="mb-4">No use of Slash Experiences's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
          <h2 className="text-xl font-semibold mt-8 mb-2">iFrames</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-2">Removal of links from our website</h2>
          ...
          <p className="mb-4">The limitations and prohibitions of liability set in this Section and elsewhere in this disclaimer: are subject to the preceding paragraph; and govern all liabilities arising under the disclaimer, including liabilities arising in contract, in tort and for breach of statutory duty.</p>
