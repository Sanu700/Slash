        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Slash Experiences, Gurugram, Haryana.</li>
              ...
              <li><b>Country</b> refers to: Haryana, India</li>
              ...
              <li><b>Website</b> refers to Slash Experiences, accessible from <a href="https://slashexperiences.in/" className="text-blue-600 underline">https://slashexperiences.in/</a></li>
          ...
          <section>
            ...
            <p className="text-black mb-2 font-medium">Personal Data</p>
            <p className="text-muted-foreground mb-4">
            ...
            <p className="text-black mb-2 font-medium">Usage Data</p>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
          <p className="text-black mb-2 font-medium">Information from Third-Party Social Media Services</p>
            <p className="text-muted-foreground mb-4">
          ...
          {/* Inserted Cookies Section */}
          <section>
            <div className="space-y-6">
              <div>
                <p className="font-medium mb-1 text-muted-foreground">Necessary / Essential Cookies</p>
              ...
              <div>
                <p className="font-medium mb-1 text-muted-foreground">Cookies Policy / Notice Acceptance Cookies</p>
                <ul className="list-disc pl-6 space-y-1 text-muted-foreground mb-2">
              ...
              <div>
                <p className="font-medium mb-1 text-muted-foreground">Functionality Cookies</p>
                <ul className="list-disc pl-6 space-y-1 text-muted-foreground mb-2">
                  <li><b>Type:</b> Persistent Cookies</li>
                  <li><b>Administered by:</b> Us</li>
          ...
          <section>
            <h2 className="text-xl font-medium mb-2">Use of Your Personal Data</h2>
          ...
          <section>
            <h2 className="text-xl font-medium mb-2">Retention of Your Personal Data</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-medium mb-2">Transfer of Your Personal Data</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-medium mb-2">Delete Your Personal Data</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-medium mb-2">Disclosure of Your Personal Data</h2>
            <p className="text-muted-foreground mb-4">Business Transactions</p>
            ...
            <p className="text-muted-foreground mb-4">Law enforcement</p>
            <p className="text-muted-foreground mb-4">Under certain circumstances, the Company may be required to disclose Your Personal Data if required by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            <p className="text-muted-foreground mb-4">Other legal requirements</p>
          ...
          <section>
            <h2 className="text-xl font-medium mb-2">Security of Your Personal Data</h2>
            <p className="text-muted-foreground mb-4">
          ...
          {/* Add more sections here for the rest of the privacy policy content, using similar formatting. */}
          <section>
