...
const Testimonials = () => {
  ...
  return (
    <main className="pt-10 sm:pt-16">
      ...
      <div 
        ref={heroRef}
        className="relative bg-gradient-to-r from-amber-700 to-orange-600 text-white py-10 sm:py-16 md:py-24"
      >
        <div className="container max-w-full sm:max-w-3xl md:max-w-6xl mx-auto px-4 sm:px-6 md:px-10">
          <div className={`text-center max-w-3xl mx-auto transition-all duration-700 ${heroInView ? "opacity-100" : "opacity-0 translate-y-8"}`}>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">Customer Stories</h1>
            ...
            <div className="flex justify-center">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-lg sm:text-xl font-medium">4.9/5 from 800+ reviews</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-full sm:max-w-3xl md:max-w-6xl mx-auto px-4 sm:px-6 md:px-10">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              {/* Image Side */}
              <div className="h-40 sm:h-64 md:h-auto relative">
                <img 
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="flex items-center">
                  <div className="rounded-full overflow-hidden w-10 h-10 sm:w-12 sm:h-12 mr-3 sm:mr-4">
                    <img 
      ...
      <section 
        ref={testimonialsRef}
        className="py-10 sm:py-16 md:py-24 bg-secondary/10"
      >
        <div className="container max-w-full sm:max-w-3xl md:max-w-6xl mx-auto px-4 sm:px-6 md:px-10">
          <h2 className={cn(
            "text-2xl sm:text-3xl font-medium mb-8 sm:mb-12 text-center transition-all duration-700",
              ...
              >
                <div className="flex mb-2 sm:mb-4">
                  ...
                  {[...Array(5 - testimonial.rating)].map((_, i) => (
                    <Star key={i + testimonial.rating} className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" />
                  ))}
                </div>
                
                <blockquote className="text-gray-800 mb-4 sm:mb-6">
                  "{testimonial.text}"
                </blockquote>
                
                <div className="flex items-center">
                  <div className="rounded-full overflow-hidden w-8 h-8 sm:w-10 sm:h-10 mr-2 sm:mr-3">
                    <img 
      ...
      <section className="py-10 sm:py-16 md:py-24">
        <div className="container max-w-full sm:max-w-3xl md:max-w-6xl mx-auto px-4 sm:px-6 md:px-10">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-medium mb-2 sm:mb-4">See Experiences in Action</h2>
