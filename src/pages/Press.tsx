...
const Press = () => {
  ...
  return (
    <main className="pt-16">
      {/* Hero Section */}
      <div ref={heroRef} className="relative bg-gradient-to-r from-gray-900 to-gray-800 text-white py-16 md:py-24">
            ...
            <div className="flex flex-wrap gap-4">
              <Button size="lg" variant="secondary" className="font-medium" asChild>
                <a href="/press-kit.zip" download>
                  Press Kit <Download className="w-4 h-4 ml-2" />
                </a>
              </Button>
              <Button size="lg" variant="outline" className="bg-[#181f2a] text-white border-white hover:bg-[#181f2a] hover:text-white" asChild>
...
const BrandCard = ({ title, description, file, fileLabel }: { title: string; description: string; file: string; fileLabel: string }) => (
